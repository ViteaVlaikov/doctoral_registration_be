...
public class StudentCrossTab implements CrossTab {
    List<StudentFilter> UPPER_CRITERIA = List.of(SPECIALITY_ID, PROFILE_ID, BRANCH_ID, DOMAIN_ID, SCHOOL_ID);
    List<StudentFilter> LOWER_CRITERIA = List.of(GENDER, STATUS, FINANCING, REGISTRATION, STUDY_TYPE,
    ...
    public StudentCrossTab(Map<String, String> params) {
        ...
        List<List<String>> list = leftCriteriaList.stream()
                ...
                .toList();
        System.out.println(leftCriteriaList);
        System.out.println(upperCriteriaList);
