package usm.api.doctoral_registration.tools.excel;
...
//            e.printStackTrace();
        ...
        rowError.forEach(e -> System.out.print(e + " "));
...
//        studentDTO.setScienceBranch(scienceBranch);
    ...
    private void readIdSpeciality(Cell cell, StudentDto studentDTO) {
        ...
        StudentDto.SpecialityDto specialityDto = new StudentDto.SpecialityDto();
...
//        studentDTO.setScienceSchool(scienceSchool);
    ...
    private void readScientificSupervisor(Cell cell, StudentDto studentDTO) {
        Supervisor supervisor = stringParser.parseStringToSupervisor(cell.getStringCellValue());
    ...
    private void readSteeringCommittee(Cell cell, StudentDto studentDTO) {
        Set<Supervisor> supervisors = stringParser.parseStringToSteeringCommittee(cell.getStringCellValue());
//
        Set<SupervisorDto> steeringCommittee = supervisors.stream()
                .map(supervisorMapper::toDto).collect(Collectors.toUnmodifiableSet());
        studentDTO.setSteeringCommittee(steeringCommittee);
    }
