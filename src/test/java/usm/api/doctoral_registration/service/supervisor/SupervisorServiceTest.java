...
class SupervisorServiceTest {
    ...
    void testSave_NewSupervisor() {
        ...
        when(scienceSchoolRepository.findById(supervisorDto.getScienceSchool().getId())).thenReturn(Optional.of(SCIENCE_SCHOOL_FULL));
        ...
        verify(scienceSchoolRepository, times(1)).findById(supervisorDto.getScienceSchool().getId());
